...
| **Amazon Bedrock** | InvokeModel | Claude 3 Sonnet (anthropic.claude-3-sonnet-20240229-v1:0) | 200K tokens input | Summary (2-3 sentences), key insights, structured data | $3.00 per 1M input tokens, $15.00 per 1M output tokens |
