...
declare const GetIngestionJobCommand_base: {
    ...
    new (__0_0: GetIngestionJobCommandInput): import("@smithy/smithy-client").CommandImpl<GetIngestionJobCommandInput, GetIngestionJobCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
