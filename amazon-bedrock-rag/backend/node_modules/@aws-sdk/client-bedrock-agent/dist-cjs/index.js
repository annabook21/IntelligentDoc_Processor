...
((FlowValidationDetails2) => {
  FlowValidationDetails2.visit = /* @__PURE__ */ __name((value, visitor) => {
    if (value.cyclicConnection !== void 0)
      return visitor.cyclicConnection(value.cyclicConnection);
    if (value.duplicateConnections !== void 0)
    ...
    if (value.unreachableNode !== void 0)
    ...
    if (value.missingEndingNodes !== void 0)
    ...
    if (value.unfulfilledNodeInput !== void 0)
    ...
    if (value.unknownNodeInput !== void 0)
      return visitor.unknownNodeInput(value.unknownNodeInput);
    if (value.unknownNodeOutput !== void 0)
...
var PromptTemplateConfigurationFilterSensitiveLog = /* @__PURE__ */ __name((obj) => {
  ...
  if (obj.chat !== void 0)
    return { chat: import_smithy_client.SENSITIVE_STRING };
  if (obj.$unknown !== void 0)
    return { [obj.$unknown[0]]: "UNKNOWN" };
...
var FlowValidationDetailsFilterSensitiveLog = /* @__PURE__ */ __name((obj) => {
  if (obj.cyclicConnection !== void 0)
    return { cyclicConnection: obj.cyclicConnection };
  if (obj.duplicateConnections !== void 0)
  ...
  if (obj.unreachableNode !== void 0)
    return { unreachableNode: obj.unreachableNode };
  if (obj.unknownConnectionSource !== void 0)
  ...
  if (obj.unknownConnectionTarget !== void 0)
  ...
  if (obj.mismatchedNodeInputType !== void 0)
    return { mismatchedNodeInputType: obj.mismatchedNodeInputType };
  if (obj.mismatchedNodeOutputType !== void 0)
  ...
  if (obj.unfulfilledNodeInput !== void 0)
  ...
  if (obj.unknownNodeInput !== void 0)
    return { unknownNodeInput: obj.unknownNodeInput };
  if (obj.unknownNodeOutput !== void 0)
...
var se_AssociateAgentCollaboratorCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  body = JSON.stringify(
    (0, import_smithy_client.take)(input, {
      agentDescriptor: (_) => (0, import_smithy_client._json)(_),
...
var se_CreateAgentCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  body = JSON.stringify(
    (0, import_smithy_client.take)(input, {
      ...
      clientToken: [true, (_) => _ ?? (0, import_uuid.v4)()],
      customOrchestration: (_) => (0, import_smithy_client._json)(_),
...
var se_DeleteKnowledgeBaseDocumentsCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  body = JSON.stringify(
    (0, import_smithy_client.take)(input, {
      clientToken: [true, (_) => _ ?? (0, import_uuid.v4)()],
      documentIdentifiers: (_) => (0, import_smithy_client._json)(_)
    })
  );
  b.m("POST").h(headers).b(body);
  return b.build();
...
var se_Tool = /* @__PURE__ */ __name((input, context) => {
  return Tool.visit(input, {
    cachePoint: (value) => ({ cachePoint: (0, import_smithy_client._json)(value) }),
...
var de_PromptFlowNodeInlineConfiguration = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    ...
    templateConfiguration: (_) => de_PromptTemplateConfiguration((0, import_core2.awsExpectUnion)(_), context),
...
var de_PromptVariant = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    additionalModelRequestFields: (_) => de_Document(_, context),
    genAiResource: (_) => (0, import_smithy_client._json)((0, import_core2.awsExpectUnion)(_)),
    inferenceConfiguration: (_) => de_PromptInferenceConfiguration((0, import_core2.awsExpectUnion)(_), context),
    metadata: import_smithy_client._json,
    modelId: import_smithy_client.expectString,
    name: import_smithy_client.expectString,
...
var de_ToolConfiguration = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    toolChoice: (_) => (0, import_smithy_client._json)((0, import_core2.awsExpectUnion)(_)),
...
var de_ToolSpecification = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    description: import_smithy_client.expectString,
    inputSchema: (_) => de_ToolInputSchema((0, import_core2.awsExpectUnion)(_), context),
    name: import_smithy_client.expectString
  });
...
((PromptGenAiResource2) => {
  PromptGenAiResource2.visit = /* @__PURE__ */ __name((value, visitor) => {
    if (value.agent !== void 0)
      return visitor.agent(value.agent);
    return visitor._(value.$unknown[0], value.$unknown[1]);
  }, "visit");
...
var PromptGenAiResourceFilterSensitiveLog = /* @__PURE__ */ __name((obj) => {
  if (obj.agent !== void 0)
    return { agent: import_smithy_client.SENSITIVE_STRING };
  if (obj.$unknown !== void 0)
    return { [obj.$unknown[0]]: "UNKNOWN" };
